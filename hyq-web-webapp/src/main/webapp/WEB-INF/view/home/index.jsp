...
<head>
    <meta charset="UTF-8">
    <title>Origin Architects Website Template</title>
...
<div class="page">
    <div class="home-page">
        <div class="sidebar">
            ...
            <div class="connect">
                <a href="#" id="fb">facebook</a> <a href="#" id="twitter">twitter</a> <a href="#" id="googleplus">google+</a> <a href="#" id="youtube">youtube</a>
            </div>
        </div>
        <div class="body">
